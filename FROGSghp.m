...
for Vtemp = 1:7
	...
	for k = 1:(WIND_DIR_NUM+1)
		...
		if FLAG_RESTRICT == 1
			...
			elseif LeleDeg == 86
				if WazDeg == 135 && Vtemp >= 4
					continue;
				elseif WazDeg == 180 && Vtemp >= 2
					continue;
				elseif WazDeg == 225 && Vtemp >= 3
					continue;
				end
			elseif LeleDeg == 87
				if WazDeg == 135 && Vtemp >= 2
					continue;
				elseif WazDeg == 180 && Vtemp >= 2
					continue;
				elseif WazDeg == 225 && Vtemp >= 3
					continue;
				elseif WazDeg == 270 && Vtemp >= 3
					continue;
				end
			elseif LeleDeg == 88
				if WazDeg == 0 && Vtemp <= 1
					continue;
				elseif WazDeg == 45 && Vtemp <= 1
					continue;
				elseif WazDeg == 90 && Vtemp <= 2
					continue;
				elseif WazDeg == 135 && Vtemp <= 2
					continue;
				elseif WazDeg == 180
					continue;
				elseif WazDeg == 225
				...
				elseif WazDeg == 270
					continue;
				elseif WazDeg == 315 && Vtemp <= 2
					continue;
				end
			elseif LeleDeg == 89
				if WazDeg == 0 && Vtemp <= 2
					continue;
				elseif WazDeg == 45 && Vtemp <= 2
					continue;
				elseif WazDeg == 90 && Vtemp <= 3
					continue;
				elseif WazDeg == 135
					continue;
				elseif WazDeg == 180
