...
% length [m]
l        = 1.700;       % total length
lcg0     = 0.878;       % center of gravity @ take-off
lcgf     = 0.831;       % center of gravity @ engine-cut-off
lcgp     = 1.230;       % center of gravity of fuel & N2O
lcp      = 1.091;       % center of pressure
d        = 0.122;       % outer diameter

% weight [kg]
m0       = 6.609;       % weight @ take-off
mf       = 5.928;       % weight @ engine-cut-off
%m0 = 6.0; mf = m0 - (7.197-6.790);

% moment of inetia [kgm^2]
I0       = 1.663;       % moment of inertia @take-off
If       = 1.498;       % moment of inertia @ engine-cut-off
Ip0      = 0.233;      % moment of inertia of fuel & N2O

% coefficient [-]
Cd       = 0.42;        % drag coefficient original 0.45 840m
Cnalpha  = 5.94;       % normal force coefficient

% parachute
Vpara1   = 12;           % falling velocity of 1st parachute [m/s]
Vpara2   = 12;           % falling velocity of 2nd parachute[m/s]
